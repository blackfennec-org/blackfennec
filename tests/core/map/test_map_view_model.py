...
from doubles.core import InfoMock, MapMock, InterprationMock
from src.core.map import MapViewModel

class MapViewModelTestSuite(unittest.TestCase):
    def test_can_construct(self):
        MapViewModel(InterprationMock(MapMock()))

    def test_can_get_value(self):
        map_view_model = MapViewModel(InterprationMock(MapMock()))
    ...
    def test_can_forward_navigation_request(self):
        interpretation = InterprationMock(MapMock())
