...
from doubles.structure.double_list import ListInstanceMock, ListMock
from doubles.structure.double_map import MapInstanceMock, MapMock
from doubles.structure.double_number import NumberMock
from doubles.structure.double_reference import ReferenceInstanceMock, ReferenceMock
