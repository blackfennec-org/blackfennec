...
from doubles.black_fennec.util.uri.double_uri_import_strategy_factory import UriImportStrategyFactoryMock
from doubles.black_fennec.util.uri.double_structure_parsing_service import StructureParsingServiceMock
from doubles.black_fennec.util.uri.double_uri_loading_strategy_factory import UriLoadingStrategyFactoryMock
