...
from blackfennec_doubles.structure.double_structure import StructureMock, NotifyingStructureMock
from blackfennec_doubles.layers.history.double_history_entry import HistoryEntryMock
...
@pytest.mark.parametrize('scenario', [
    ...
    ([Action.CHANGE, Action.CHANGE, Action.RESULT, Action.UNDO, Action.UNDO, Action.REDO, Action.REDO]),
    ([Action.CHANGE, Action.RESULT, Action.UNDO, Action.REDO, Action.UNDO, Action.REDO]),
    ([Action.CHANGE, Action.UNDO, Action.CHANGE, Action.RESULT, Action.UNDO, Action.REDO]),
])
